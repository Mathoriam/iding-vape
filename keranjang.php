<?php 
	...
	if ($totalBarang == 0) {
		...
		echo "<tr>
			...
			<td class='kanan hapus_item'>".rupiah($total)."<a href='".BASE_URL."hapus_item.php?barang_id=$barang_id'><img src='".BASE_URL."images/images.png' height='25px' /></a></td>
			 </tr>";			
		$no ++;
		}
		...
		echo "<tr>
				  ...
				  <td colspan='5' class='kanan'>".rupiah($subtotal)."</td>
			  </tr>";
